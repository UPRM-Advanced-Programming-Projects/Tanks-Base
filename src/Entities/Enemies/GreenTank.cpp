...
void GreenTank::shoot(std::vector<Projectile*> &projectiles, std::pair<double, double> target) {
...
void GreenTank::targetSystem(CustomHitbox target, std::vector<Block*> blocks) {
...
void GreenTank::move(std::vector<Block*> &blocks) {
...
void GreenTank::projectileCollision(std::vector<Projectile*> &projectiles) {
