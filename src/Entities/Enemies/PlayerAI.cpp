...
void PlayerAI::shoot(std::vector<Projectile*> &projectiles, std::pair<double, double> pos, std::pair<double, double> vel, float speed, bool isMoving) {
    std::pair<double, double> target = pos;
    if (isMoving) {
        target = Math::getPointOfIntersection(this->projectileSpeed, this->position, speed, 
        pos, vel);
    }
...
void PlayerAI::targetSystem(CustomHitbox target, std::vector<Block*> blocks) {
...
void PlayerAI::move(std::vector<Block*> &blocks) {
...
void PlayerAI::projectileCollision(std::vector<Projectile*> &projectiles) {
...
void PlayerAI::trackTarget(CustomHitbox target, std::vector<Block*> blocks) {
